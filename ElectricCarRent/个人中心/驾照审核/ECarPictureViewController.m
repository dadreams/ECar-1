...
- (void)buttonAction:(UIButton *)button
{
    if ([ECarConfigs shareInstance].user.islock.integerValue == 1) {
        UIAlertView *alertV = [[UIAlertView alloc] initWithTitle:@"用户已锁定" message:@"用户状态被锁定，如有疑问，请联系客服：400-8939091。" delegate:nil cancelButtonTitle:@"确认" otherButtonTitles:nil];
        [alertV show];
        return;
    }
