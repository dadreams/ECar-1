...
#define FontSizeMax   [UIFont systemFontOfSize:23]
#define FontSizeMiddle   [UIFont systemFontOfSize:21]
#define FontSizeMin   [UIFont systemFontOfSize:18]
#define FontType  [UIFont systemFontOfSize:15.f]
