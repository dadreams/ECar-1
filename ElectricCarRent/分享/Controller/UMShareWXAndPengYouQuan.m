...
-(void)buttonAction:(UIButton*)button
{
    ...
    if (button.tag == 200) {
        ...
        [UMSocialSnsService presentSnsIconSheetView:nil
                                             appKey:@"56681c84e0f55a569400199c"
                                          shareText:@"快快来下载"
                                          shareImage:data
        ...
        [UMSocialData defaultData].extConfig.wechatSessionData.url = @"http://www.dreamers-makers.com:9888/car/AppWeb/AppWx.html";
        ...
        [UMSocialData defaultData].extConfig.wechatTimelineData.url = @"http://www.dreamers-makers.com:9888/car/AppWeb/AppWx.html";
        [UMSocialSnsService presentSnsIconSheetView:nil
                                             appKey:@"56681c84e0f55a569400199c"
                                          shareText:@"sqAsq"
                                         shareImage:nil
...
{
        socialData.extConfig.wechatTimelineData.url = @"http://www.dreamers-makers.com:9888/car/AppWeb/AppWx.html";//        socialData.urlResource.
        socialData.extConfig.wechatSessionData.url = @"http://www.dreamers-makers.com:9888/car/AppWeb/AppWx.html";
}
